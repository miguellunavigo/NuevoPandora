...
(function () {
    ...
    const orderAreaChartEl = document.querySelector('#orderChart'),
        orderAreaChartConfig = {
            ...
            series: JSON.parse($("#hdnorderString").val()).series,
            xaxis: {
                show: false,
                lines: {
                    show: false
    ...
    const totalRevenueChartEl = document.querySelector('#totalRevenueChart'),
        totalRevenueChartOptions = {
            series: JSON.parse($("#hdntotalRevenueString").val()).series,
            chart: {
                height: 300,
                stacked: true,
                type: 'bar',
    ...
    const revenueBarChartEl = document.querySelector('#revenueChart'),
        revenueBarChartConfig = {
            ...
            series: JSON.parse($("#hdnrevenueString").val()).series,
            legend: {
                show: false
            },
            xaxis: {
                categories: JSON.parse($("#hdnrevenueString").val()).categories,
                axisBorder: {
                    show: false
                },
                axisTicks: {
    ...
    const incomeChartEl = document.querySelector('#incomeChart'),
        incomeChartConfig = {
            series: JSON.parse($("#hdntecnologiaString").val()).series,
            chart: {
                height: 215,
            ...
            xaxis: {
                categories: JSON.parse($("#hdntecnologiaString").val()).categories,
                axisBorder: {
                    show: false
                },
                axisTicks: {
